                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        ...
                        <?php if ($productsInCart): ?>
                            ...
                            <table class="table-bordered table-striped table">
                                ...
                                <?php foreach ($products as $product): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-default checkout" href="/index.php/cart/delete/<?php echo $product['id'];?>">
                            ...
                            <a class="btn btn-default checkout" href="/index.php/cart/checkout"><i class="fa fa-shopping-cart"></i> Оформить заказ</a>
                        <?php else: ?>
                            <p>Корзина пуста</p>
